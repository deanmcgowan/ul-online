...
function StopDirectionCard({
  ...
  const destinationName = useMemo(
    () => pickPreferredDestinationName(arrivals, platform.stop_name),
    [arrivals, platform.stop_name],
  );

  const cardTitle = useMemo(
    () => getStopCardTitle(platform, strings, destinationName),
    [platform, strings, destinationName],
  );
